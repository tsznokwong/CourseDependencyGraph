...
void CourseInfoWidget::setCourseInfo() {
    ...
    this->ui->courseCodeLabel->setText(this->course->getCourseCode().description() + "(" + QString::number(this->course->getCredit()) + ")");
    this->ui->titleLabel->setText(this->course->getTitle());
    ...
    this->ui->attributesLabel->setText(attributeDescription);
